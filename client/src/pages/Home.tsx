...
<div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
        <div className="hidden sm:flex items-center bg-neutral-900/90 backdrop-blur-md text-white px-4 py-2.5 rounded-2xl shadow-xl border border-[#C99A3A]/40 text-xs font-medium animate-pulse">
          <span>Entre em contato com seu dentista agora</span>
        </div>
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-2xl whatsapp-float-btn transition-all duration-300 hover:scale-110 active:scale-95"
